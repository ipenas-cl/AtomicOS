/*
 * Tempo Compiler v3.0.0 - Extended Version for Ideal OS
...
int main(int argc, char* argv[]) {
    ...
    printf("     ╚═╝   ╚══════╝╚═╝     ╚═╝╚═╝      ╚═════╝ \n");
    printf("\n");
    printf("  Tempo v3.0.0 - Deterministic Programming Language\n");
    printf("  Processing: %s\n", argv[1]);
    printf("  ================================================\n\n");
    ...
    if (ast) {
        ...
        fprintf(output, "; Generated by Tempo v3.0.0 Compiler\n");
