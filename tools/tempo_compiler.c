 ...
 *
 * Tempo Compiler v1.2.1 - Complete Systems Programming Language
...
int main(int argc, char* argv[]) {
    ...
    printf("     ╚═╝   ╚══════╝╚═╝     ╚═╝╚═╝      ╚═════╝ \n");
    printf("\n");
    printf("  Tempo v1.2.1 - Complete Systems Programming Language\n");
    printf("  Processing: %s\n", argv[1]);
    printf("  ================================================\n\n");
    ...
    if (ast) {
        ...
        fprintf(output, "; Generated by Tempo v1.2.1 Compiler\n");
