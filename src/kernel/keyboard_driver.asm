...
; 
; Deterministic PS/2 keyboard driver
...
kb_handler:
    ...
    ; Use shift table
    mov al, [shift_scancode_table + ebx]
    jmp .store_char
...
.store_char:
    ...
    mov ebx, [kb_write_ptr]
    mov ecx, [kb_count]
    cmp ecx, KB_BUFFER_SIZE
